			...
			<div class="row">
				<div class="col-lg-12">
					<div class="counter-content">
						<h2>Welcome to Department of Informatics Engineering Hasanuddin University</h2>
					</div>
				</div>
			</div>
		</div>
							...
							<div class="col-lg-6">
								<div class="enroll-list text-white" style="padding: 68px 0px;">
									<div class="enroll-list-item">
										...
										<p>A master of informatics engineering has sufficient knowledge and is able to develop his expertise in following the progress of science and the needs of society.</p>
						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade-animation show active" id="mahasiswa" role="tabpanel" aria-labelledby="mahasiswa-tab">
								<div class="enroll-list text-white" style="padding: 68px 0px;">
									<div class="enroll-list-item">
										<h5>Students</h5>
										<p>Informatics engineering students are able to choose solutions to problems in the field of engineering that can be accounted for in terms of safety, economics and technicality.</p>
				...
				<div class="col-lg-4">
					<div class="card-view" style="margin:5px">
						<div id="beranda-penelitian" class="counter-content">
							...
							<p style="color:black">The following are the results of the latest research conducted by informatics engineering lecturers.</p>
				...
				<div class="col-lg-4">
					<div class="card-view" style="margin:5px">
						<div id="beranda-publikasi" class="counter-content">
							...
							<p style="color:black">The following are the results of the latest publications conducted by informatics engineering lecturers.</p>
				...
				<div class="col-lg-4">
					<div class="card-view" style="margin:5px">
						<div id="beranda-kerjasama" class="counter-content">
							...
							<p style="color:black">The Department of Informatics Engineering has a strong tradition of collaborating with external parties.</p>
