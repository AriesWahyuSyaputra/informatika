						...
						<div class="tab-content" id="myTabContent">
							<div class="tab-pane fade-animation show active" id="mahasiswa" role="tabpanel" aria-labelledby="mahasiswa-tab">
								<div class="enroll-list text-white" style="padding: 68px 0px;">
									<div class="enroll-list-item">
										<h5>Mahasiswa</h5>
										<p>Mahasiswa teknik elektro mampu memilih penyelesaian persoalan bidang teknik yang dapat dipertanggungjawabkan dari segi keselamatan, ekonomi dan teknis.</p>
							...
							<div class="tab-pane fade-animation" id="alumni" role="tabpanel" aria-labelledby="alumni-tab">
								<div class="enroll-list text-white" style="padding: 68px 0px;">
									<div class="enroll-list-item">
										<h5>Alumni</h5>
										<p>Alumni mampu melakukan inovasi di bidang Informatika dengan efektif dan efisien.</p>
